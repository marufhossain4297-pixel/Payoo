    ...
    .addEventListener('click', function () {
        ...
        <div class="card bg-base-100 w-full shadow rounded-3xl flex relative">
                ...
                <div class="flex items-center">
                    ...
                    <p class="self-center text-[12px] text-[#525252] mt-[5px] mb-[6px] "> <span class = "font-medium text-[13px]">Withdraw successful ✅</span><br>  Amonut: <span class = "text-[#EF4444] font-semibold text-[13px]"> -${cashoutAmount} $</span><br> Account Number: ${cashoutNumberInput}<br> Date: ${formattedDate} </p>
                </div>
            </div>
            <br>
    `
